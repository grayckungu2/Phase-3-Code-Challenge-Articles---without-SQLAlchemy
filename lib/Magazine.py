...
# declare in variable
# As __all__ is a list, so we can only pass the string values in the list and 
# not the function
    _all = [] 
    ...
    def contributing_authors(self):
        ...
        for author, count in authors.items():# A for loop is used for iterating over a sequenc
